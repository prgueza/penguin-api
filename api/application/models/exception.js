...
const ExceptionSchema = mongoose.Schema({
  ...
  api: { type: String, enum: ['application'] },
  typology: { type: String, enum: ['auth'] },
  prefix: { type: String, enum: ['SI', 'SU', 'WT', 'VC', 'RC'] },
...
module.exports = mongoose.connection.useDb('application').model('Exception', ExceptionSchema)
